...
// ---------------- SALES GRAPH ----------------
var chartDom = document.getElementById('sales-graph');
...
// Initialize ECharts for Visuals Section
...
var salesData = [5000000, 7000000, 6500000, 8000000, 9000000, 12000000];
var expensesData = [3000000, 4000000, 4200000, 5000000, 5500000, 7000000];

option = {
  title: {
    text: 'Sales vs Expenses Overview',
    left: 'center',
    textStyle: { color: '#fff' }
  },
  tooltip: {
